...
@Component({
  selector: 'app-fullwidthsecondarycolumnonrigh',
  templateUrl: './fullwidthsecondarycolumnonrigh.component.html',
  animations: [ 
    trigger('opacity', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class FullwidthsecondarycolumnonrighComponent {
