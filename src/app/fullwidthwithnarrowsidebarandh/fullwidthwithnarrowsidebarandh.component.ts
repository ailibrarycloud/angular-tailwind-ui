...
@Component({
  selector: 'app-fullwidthwithnarrowsidebarandh',
  templateUrl: './fullwidthwithnarrowsidebarandh.component.html',
  animations: [ 
    trigger('opacity', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class FullwidthwithnarrowsidebarandhComponent {
