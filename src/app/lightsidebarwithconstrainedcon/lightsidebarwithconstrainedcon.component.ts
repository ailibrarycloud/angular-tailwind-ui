...
@Component({
  selector: 'app-lightsidebarwithconstrainedcon',
  templateUrl: './lightsidebarwithconstrainedcon.component.html',
  animations: [ 
...
export class LightsidebarwithconstrainedconComponent {
