...
@Component({
  selector: 'app-lightsidebarwithheader',
  templateUrl: './lightsidebarwithheader.component.html',
  animations: [ 
    trigger('opacity', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class LightsidebarwithheaderComponent {
...
@NgModule({
  declarations: [
    LightsidebarwithheaderComponent,
  ],
  imports: [
    BrowserModule,
